                ...
                <div class="card has-background-white has-text-black">
                     <header class="card-header">
                        ...
                        <p class="card-header-icon">
                         <NuxtLink to="/family/create" class="button is-link has-background-primary">
                        Create New Family</NuxtLink>
                        </p>
                      </header>
                ...
                <vue-good-table
                    ...
                    <template slot="table-row" slot-scope="props">
                        <span v-if="props.column.field == 'action'">
                            <NuxtLink :to="'family/' + rows[props.row.originalIndex].id" class="button is-link has-background-primary">
                                Edit</NuxtLink>
                            <button @click="deleteFamily(rows[props.row.originalIndex].id)" class="button is-danger">
                                Delete</button>
                        </span>
