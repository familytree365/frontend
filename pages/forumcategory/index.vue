                ...
                <div class="card has-background-white has-text-black">
                     <header class="card-header">
                        ...
                        <p class="card-header-icon">
                         <NuxtLink to="/forumcategory/create" class="button is-link has-background-primary">
                ...
                <vue-good-table
                    ...
                    <template slot="table-row" slot-scope="props">
                        <span v-if="props.column.field == 'action'">
                            <NuxtLink :to="'forumcategory/' + rows[props.row.originalIndex].slug" class="button is-link has-background-primary">
                                Edit</NuxtLink>
                            <button @click="deleteEvent(rows[props.row.originalIndex].slug)" class="button is-danger">
                                Delete</button>
                        </span>
...
export default {
    ...
    methods: {
        ...
        async loadItems() {
            const response = await this.$axios.$get("/api/forumcategory", {
