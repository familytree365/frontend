                ...
                <div class="card has-background-white has-text-black">
                     <header class="card-header">
                        ...
                        <p class="card-header-icon">
                         <NuxtLink to="/personname/create" class="button is-link has-background-primary">
                        Create New PersonName</NuxtLink>
                        </p>
                      </header>
                ...
                <vue-good-table
                    ...
                    <template slot="table-row" slot-scope="props">
                        <span v-if="props.column.field == 'action'">
                            <NuxtLink :to="'personname/' + rows[props.row.originalIndex].id" class="button is-link has-background-primary">
                                Edit</NuxtLink>
                            <button @click="deletePersonName(rows[props.row.originalIndex].id)" class="button is-danger">
                                Delete</button>
                        </span>
    ...
    methods: {
        ...
        deletePersonName(id) {
             if(confirm("Do you really want to delete?")){
               ...
               const response = this.$axios.$delete("/api/personname/" + id)
