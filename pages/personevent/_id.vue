...
export default {
    ...
    methods: {
        save() {
            ...
            if (this.$v.$invalid) {
                ...
                this.$axios.$put('/api/personevent/'+this.$route.params.id, this.personeventevent)
    ...
    async asyncData({ $axios,params }) {
      const personeventevent = await $axios.$get('/api/personevent/'+params.id)
      return { personeventevent }
    }
}
</script>
