              ...
              <div class="profile_dropdown_content">
                <div class="is-flex fd--r px-3 py-2">
                  ...
                  <div class="is-flex fd--c ai--fs">
                    <span
                      class="is-size-7 has-text-black has-text-weight-medium"> {{ loggedInUser.first_name }}  </span>
          ...
          <div class="menu-wrapper py-1">
            <aside class="menu">
              <ul class="menu-list">
                ...
                <li class="collapsible" id="information" v-if="getPermission.includes('files menu')"
                    @click="menuDropdown('information')">
                  <a href="#">
                ...
                <div class="content mb-0">
                  <ul>
                    <li v-if="getPermission.includes('objects index')">
                      <NuxtLink to="/mediaobject">
                        <font-awesome-icon :icon="['fas', 'angle-right']" class="mt-1 mr-2"/>
                        Objects
                      </NuxtLink>
                    </li>
                ...
                <li class="collapsible" id="sources" v-if="getPermission.includes('sources menu')"
                    @click="menuDropdown('sources')">
                  <a href="#">
                ...
                <li class="collapsible" id="people" v-if="getPermission.includes('people menu')"
                    @click="menuDropdown('people')">
                  <a>
                ...
                <li class="collapsible" id="family" v-if="getPermission.includes('family menu')"
                    @click="menuDropdown('family')">
                  <a href="#">
                ...
                <li class="collapsible" id="references" v-if="getPermission.includes('references menu')"
                    @click="menuDropdown('references')">
                  <a href="#">
                ...
                <li class="collapsible" id="trees" v-if="getPermission.includes('trees menu')"
                    @click="menuDropdown('trees')">
                  <a href="#">
                ...
                <li class="collapsible" id="forum" v-if="getPermission.includes('forum menu')"
                    @click="menuDropdown('forum')">
                  <a href="#">
                    <font-awesome-icon :icon="['fas', 'question-circle']" class="mt-1 mr-2"/>
                    Forum
                    <font-awesome-icon :icon="['fas', 'angle-down']" class="mt-1 mr-2 is-pulled-right"/>
                ...
                <li @click="menu" class="simplemenu">
                  <NuxtLink to="/gedcom-export">
                    <font-awesome-icon :icon="['fas', 'download']" class="mt-1 mr-2"/>
                    GEDCOM Export
                  </NuxtLink>
                </li>
      ...
      <div class="column is-10-desktop is-offset-2-desktop is-9-tablet is-offset-3-tablet is-12-mobile pb-0">
        <div class="p-1 wrapper">
          ...
          <footer class="footer mt-5">
            Copyright &copy; Family Tree 365 Ltd,<br> Unit A, 82 James Carter Road, Mildenhall, Suffolk, England, IP28
            7DE<br> Company
            number 12734769
          </footer>
        </div>
